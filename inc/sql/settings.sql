...
(1, 'telegram_merchant_bot_token', ''),
(1, 'telegram_merchant_bot_username', ''),
(1, 'telegram_merchant_webhook_url', ''),
(1, 'telegram_merchant_webhook_connected_at', ''),
(1, 'telegram_merchant_webhook_last_error', ''),
(1, 'telegram_merchant_webhook_lock', '0'),
(1, 'telegram_operator_bot_token', ''),
(1, 'telegram_operator_bot_username', ''),
(1, 'telegram_operator_webhook_url', ''),
(1, 'telegram_operator_webhook_connected_at', ''),
(1, 'telegram_operator_webhook_last_error', ''),
(1, 'telegram_operator_webhook_lock', '0'),
(1, 'telegram_service_bot_token', ''),
(1, 'telegram_service_bot_username', ''),
(1, 'telegram_service_webhook_url', ''),
