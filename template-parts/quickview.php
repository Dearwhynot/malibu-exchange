 ...
 * Quickview panel.
 *
 * В оригинальном HTML этот блок был огромным demo-комбайном:
 * notes / alerts / chat / search overlay и прочее.
 *
 * Для быстрого и практичного старта лучше не тащить это всё в прод.
 * Поэтому здесь оставлен пустой, безопасный и понятный каркас.
 *
 * Если позже понадобится правый выезжающий сайдбар —
 * расширяй именно этот partial.
 */
if (!defined('ABSPATH')) {
    exit;
}
