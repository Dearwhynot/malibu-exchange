# AGENT.md — project-briefs

## EN
This module should stay focused on its own responsibility: optional project briefs and task support.
...
## RU
Этот модуль должен оставаться сфокусированным на своей задаче: необязательные project briefs и support для задач.
