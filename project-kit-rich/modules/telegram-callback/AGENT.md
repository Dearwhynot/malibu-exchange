# AGENT.md — telegram-callback

## EN
This module should stay focused on its own responsibility: telegram webhook / callback endpoint.
...
## RU
Этот модуль должен оставаться сфокусированным на своей задаче: telegram webhook / callback endpoint.
