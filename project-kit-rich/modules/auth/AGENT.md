...
## EN
This module should stay focused on its own responsibility: authentication and access control.
...
## RU
Этот модуль должен оставаться сфокусированным на своей задаче: авторизация и контроль доступа.
